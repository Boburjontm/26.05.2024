...
const Order = ({ setSearchValue, setRegion }) => {
    ...
    <div
      ...
      ${
        darkMode
          ...
          : " bg-[#0d1d2c] text-white fixed w-full px-12 md:px-20  md:top-20 top-12 sm:top-[59px] py-4 container mx-auto "
      }`}
    >
      <form
...
flex gap-4 px-6 w-full md:w-[400px] py-3 items-center ${
            darkMode
              ? " bg-white  text-[#858585] shadow-custom-gray rounded-md"
              : " bg-[#112435]shadow-lg rounded-md"
          }`}
        >
          <CiSearch />
          <input
